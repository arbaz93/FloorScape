...
export const STORAGE_PATHS = {
    ROOT: "floorscape",
    SOURCES: "floorscape/sources",
    RENDERS: "floorscape/renders",
} as const;
...
export const FLOORSCAPE_RENDER_PROMPT = `
...
5) **White space must be same**: White space surrounding the plan must be same
